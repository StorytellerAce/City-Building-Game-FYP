...
/// <summary>
/// Obsolete system component. Was previously part of the architecture for undo and redo actions, where each action executed through this handles the do and undo logic. Currently not in use, but can be reintroduced if  want to add undo/redo functionality for player actions in the future.
